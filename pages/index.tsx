...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex max-w-5xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      <Head>
        <title>Overwhelmed - tackle your stress with AI</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className="flex flex-col items-center justify-center min-h-screen mt-8">
        <div className="text-left max-w-2xl w-full">
          <p className="sm:text-4xl text-4xl text-slate-900">swamped 😪</p>
          <h1 className="text-slate-900">
            a helper for those days you're feeling overwhelmed.
          </h1>
          <p className="text-slate-600 mt-5">
            when your to-do list refuses to budge and you have too much on your
            plate.
          </p>
          <p> unload, rant, let it out on the page. we'll help you plan</p>

          <div class="flex flex-col items-end">
            <a
              href="#"
              className="text-purple-700 hover:text-purple-900 hover:underline font-semibold text-sm mt-1 mr-3"
            >
              how does this work?
            </a>
          </div>
          ...
          <div className="mt-4t s">
            ...
            ></textarea>
            <button
              className="mt-4 px-6 py-2 bg-purple-700 text-white font-semibold rounded-md hover:bg-purple-800 transition duration-150 ease-in-out"
              onClick={submitRant}
            >
              Submit
            </button>
...
//         <h1 className="sm:text-2xl text-2xl font-bold text-slate-900">
//           for those days you're feeling overwhelmed
//         </h1>
